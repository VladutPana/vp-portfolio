...
const expandableCardsApp = () => {
  return (
    <div className='w-full'>
      {/* top div */}
      <div className='w-screen h-[50vh] relative'> 
        <div className='absolute top-0 left-0 w-full h-[50vh] bg-black/70 z-10' />
        <Image className='absolute z-1' layout='fill' objectFit='cover' src={expandableCards} alt='/'/>
        ...
        <div className='col-span-4 md:col-span-1 shadow-md shadow-[#5651e5] rounded-xl py-4'>
          <div className='p-2'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1'>
              ...
              <p className='py-2 flex items-center'><RiRadioButtonFill className='pr-1' /> Framer Motion</p>
            </div>
          </div>
        </div>
...
export default expandableCardsApp;
