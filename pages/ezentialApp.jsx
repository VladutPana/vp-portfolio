    ...
    <div className='w-full'>
      ...
      <div className='max-w-[77.5rem] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        ...
        <div className='col-span-4'>
          ...
          <a
            href='https://github.com/VladutPana/vp-ezential-app-repo'
            target='_blank'
            rel='noreferrer'>
          ...
          <a
            href='https://vladutpana.github.io/vp-ezential-app-repo/'
            target='_blank'
            rel='noreferrer'>
